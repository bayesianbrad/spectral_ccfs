function predictinf2specontrain(country,source,city,testcity,type,method,multiclass, class_map,classes_remove,ntrees,server,predict, predict_data)
...
if strcmp(testcity,city)
    disp(' Training validating on test.');
end
...
if ~exists('predict','var')
    predict = 0;
end
if ~exists('predict_data', 'var')
    predict_data = 0;
end
